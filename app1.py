...
original_df = pd.read_csv("crop_growth_updated_dataset.csv")
...
if st.button("🔍 Predict Requirements"):
    try:
        ...
        scaler_encoder = joblib.load("scaler.joblib")
        ...
        # Load the models
        water_model = joblib.load("gb_water.joblib")
        gb_water = water_model['model']
        label_encoders_target_water = water_model['labels']
        temp_model = joblib.load("gb_temp.joblib")
